...
add_action( 'tgmpa_register', 'falcons_theme_register_required_plugins' );



function falcons_theme_register_required_plugins() {
    ...
    $plugins = array(
		array(
            ...
            'source'             => get_stylesheet_directory() . '/framework/ext/plugins/revslider.zip', // The plugin source.
