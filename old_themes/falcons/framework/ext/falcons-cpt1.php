...
class cpt1_listing extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array('classname' => 'falcons_widget_recent_entries', 'description' => ucwords($directory_url_1). esc_html__( " Listing",'falcons' ) );
        parent::__construct('cpt1_latest', ucwords($directory_url_1).esc_html__(' Listing','falcons' ), $widget_ops);
    ...
    public function widget($args, $instance) {
        ...
        $cache = wp_cache_get('cpt1_listing_widget', 'widget');
		...
		include( get_template_directory(). '/framework/ext/widget-latest-cpt1.php' ); 
    ...
    function flush_widget_cache_falcons() {
        ...
        wp_cache_delete('cpt1_listing_widget', 'widget');
...
add_action('widgets_init', 'cpt1_listing');

function cpt1_listing(){

    register_widget('cpt1_listing');
