 ...
 * @since 2.8.0
 */
class falcons_Legal extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'falcons_widget_falcons_legal', 'description' => esc_html__('Arbitrary text or HTML.','falcons'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('falcons_falcons_legal', esc_html__('falcons Legal ','falcons'), $widget_ops, $control_ops);
	}
...
?>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('story')); ?>"><?php esc_html_e('Our Privacy & Policy Link:','falcons'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('mission')); ?>"><?php esc_html_e('Terms & Conditions Link:','falcons'); ?></label>
		...
		<p><label for="<?php echo esc_attr($this->get_field_id('journal')); ?>"><?php esc_html_e('Secure Payments Link:','falcons'); ?></label>
...
add_action('widgets_init', 'falcons_legal');

function falcons_legal(){

    register_widget('falcons_Legal');
