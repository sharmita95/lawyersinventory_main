 ...
 * @since 2.8.0
 */
class falcons_Logo extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'falcons_widget_falcons_logo', 'description' => esc_html__('Arbitrary text or HTML.','falcons'));
		$control_ops = array('width' => 400, 'height' => 350);
		parent::__construct('falcons_falcons_logo', esc_html__('falcons Logo ','falcons'), $widget_ops, $control_ops);
	}
...
add_action('widgets_init', 'falcons_logo');

function falcons_Logo(){

    register_widget('falcons_logo');
