 ...
 * @since 2.8.0
 */
class falcons_Widget_Tag_Cloud extends WP_Widget {

	public function __construct() {
		$widget_ops = array( 'description' => esc_html__( "A cloud of your most used tags.",'falcons') );
		parent::__construct('tag_cloud', esc_html__('falcons Tag Cloud','falcons'), $widget_ops);
	}
...
?>
	...
	<p><label for="<?php echo esc_attr($this->get_field_id('taxonomy')); ?>"><?php esc_html_e('Taxonomy:','falcons') ?></label>
...
add_action('widgets_init', 'falcons_tag');

function falcons_tag(){
    register_widget('falcons_Widget_Tag_Cloud');
}
