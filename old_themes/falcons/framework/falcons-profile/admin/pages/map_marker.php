						...
						foreach ( $terms as $term ) {  ?>
							...
							<td> 
									<div id="cate_<?php echo $term->term_id;?>" class="">
										...
										<input type="text" class="set_cat_img" termid="<?php echo $term->term_id;?>">
									...
									foreach ( $categories as $term_sub ) { ?>
										<tr>							  
											...
											<!--<button type="button" onclick="change_marker_image('<?php echo $term_sub->term_id;?>');"  class="btn btn-success btn-xs">Change Image</button>-->
												...
												<br/>	
												<input type="text" class="set_cat_img" termid="<?php echo $term_sub->term_id;?>">	
													 	<br/>	
...
<script>
	...
	function change_cate_image(cat_image_id){	
        ...
        // event.preventDefault();
        /*
        var image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
            // Set the title of the modal.
        ...
        console.log(image_gallery_frame);
	...
	jQuery(document).ready(function($) {
	    ...
	    $('.set_cat_img').on('change', function() {
	        
	        var catid = $(this).attr("termid");
	        var val = $(this).val();
    	    //alert(a);
    	    //alert(val);
    	    var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
            ...
            jQuery.ajax({
        		...
        		success: function(response) {   
        			if(response=='success'){				
        				...
        				jQuery('#cate_'+catid).html('<img width="100px" src="'+attachment.url+'">'); 
