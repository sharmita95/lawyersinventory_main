	    ...
	    <div class="panel with-nav-tabs panel-info">
				<div class="panel-heading">
						<ul class="nav nav-tabs">
							<li class="active page"><a href="#page" data-toggle="tab"><?php _e('Page','falcons'); ?></a></li>
							<li class="dir-cpt"><a href="#dir-cpt" data-toggle="tab"><?php _e('Listing URL','falcons'); ?> </a></li>
							<li class="dir-setting"><a href="#dir-setting" data-toggle="tab"><?php _e('Directory','falcons'); ?> </a></li>
							<li class="dir-marker"><a href="#dir-marker" data-toggle="tab"><?php _e('Category Image/Marker','falcons'); ?></a></li>
							<li class="payment"><a href="#payment" data-toggle="tab"><?php _e('Payment Page','falcons'); ?></a></li>
							<li class="email"><a href="#email" data-toggle="tab"><?php _e('Email','falcons'); ?> </a></li>								
							<li class="mailchimp"><a href="#mailchimp" data-toggle="tab"><?php _e('MailChimp','falcons'); ?> </a></li>
							<li class="user_reg"><a href="#user_reg" data-toggle="tab"><?php _e('Page Redirect','falcons'); ?></a></li>								
							<li class="protected_content"><a href="#protected_content" data-toggle="tab"><?php _e('Visibility Control','falcons'); ?></a></li>
							<li class="tax"><a href="#tax" data-toggle="tab"><?php _e('Tax','falcons'); ?></a></li>
