...
data-validation-length="2-6" data-validation-error-msg="<?php esc_html_e('CVV number is not correct',"falcons"); ?>" placeholder="<?php esc_html_e('Enter card CVC',"falcons"); ?>" >
					...
					<div class="row">
						<div class="col-md-4 col-xs-4 col-sm-4 "> 
								...
								<div class="col-md-8 col-xs-8 col-sm-8 "> 
								<label>
								  <input type="checkbox" data-validation="required" data-validation-error-msg="You have to agree to our terms "  name="check_terms" id="check_terms"> <?php echo $term_text; ?>
								</label>
