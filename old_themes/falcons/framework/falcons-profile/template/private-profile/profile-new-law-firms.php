						  ...
						  <div class="panel-body">	
							  <?php
								...
								//if($this->check_write_access('lawyer')){
										...
										$sql="SELECT * FROM $wpdb->posts WHERE post_type='".$directory_url_2."'  and post_author='".$current_user->ID."' ORDER BY `post_title` ASC ";
									...
									<?php													
										    ...
										    _e('Please add '.$directory_url_2,'falcons');
										}	
									?>
