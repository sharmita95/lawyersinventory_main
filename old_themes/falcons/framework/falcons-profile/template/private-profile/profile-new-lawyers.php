		...
		?>					
			...
			if(!empty($old_location_arr)) {
				foreach ( $old_location_arr as $tax ) {
                    array_push($selected_location_arr,$tax->slug);
                }
			} */
            //print_r($selected_location_arr);
            ?>
				  ...
				  <div class="panel-body">
					<div class=" form-group">
						...
						foreach ( $availability_fields as $field_value ) { ?>	
							<div class="col-md-4">
								<label class="form-group"> <input type="checkbox" name="availability_arr[]" id="availability_arr[]" value="<?php echo $field_value; ?>"> <?php echo $field_value; ?> </label>  
							</div>
						<?php
						}
						?>															
				...
				<div class="panel-heading">
				  <h4 class="panel-title col-lg-10">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapsethirty3">
					  <?php esc_html_e('Office(s)','falcons'); ?>
					</a>
				  </h4>
					<h4 class="panel-title" style="text-align:right;color:#1AA2E1;font-size:12px;">
					<a data-toggle="collapse" data-parent="#accordion" href="#collapsethirty3">
					  ...
					  <div id="offices">
						 <div id="office">	
							...
							<div class=" form-group">
								...
								<div class="  "> 
									<input type="text" class="" name="office_location[]" id="office_location[]" value="" placeholder="<?php esc_html_e('Enter Office location *required','falcons'); ?>">
								</div>																
							</div>		
							<div class=" form-group">
								...
								<div class="  "> 
									<input type="text" class="" name="office_address[]" id="office_address[]" value="" placeholder="<?php esc_html_e('Enter Office Address','falcons'); ?>">
								</div>																
							</div>
							<div class=" form-group">
								...
								<div class="  "> 
									<input type="text" class="" name="office_ph[]" id="office_ph[]" value="" placeholder="<?php esc_html_e('Enter Office Phone Number','falcons'); ?>">
								</div>																
							</div>	
						</div>
