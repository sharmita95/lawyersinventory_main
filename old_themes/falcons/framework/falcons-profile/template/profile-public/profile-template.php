            ...
            <div class="col-md-9 col-sm-8 border-blue">
              <div class="profile-content">
                  <div class="portlet-body ">
                    ...
                    <!--  <h2 class="caption-subject font-blue-madison bold uppercase"><?php esc_html_e('User Listing','falcons'); ?> </h2>-->
                    <!--</div>-->
                    <h1 class="portlet-title clearfix"><?php esc_html_e('User Listing','falcons'); ?> </h1>
                  <!--</div>-->
                  <!--<div class="portlet-body">-->
