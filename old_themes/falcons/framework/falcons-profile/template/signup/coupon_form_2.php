<div id="coupon-div" style="display: none;">							
		...
		<label class="col-md-3 control-label"><?php  esc_html_e('Discount Coupon','falcons');?></label>			
		...
		<div class="row form-group">
			<label  class="col-md-3 control-label"><?php  esc_html_e('(-) Discount','falcons');?></label>
