...
?>
    <div class="doctor-feature-content pt50 home-shortcodes lawfirm-feature-content" style="background: url(<?php echo $backg_image;?>) top center no-repeat;background-size: cover;position: relative;padding-top: 30px;">
    	<div class="container">
    	        ...
    	        <div class="vc_column-inner">
    	            <div class="wpb_wrapper">
    	                <div class="vc_btn3-container vc_btn3-center">
    	                    <a class="vc_general vc_btn3 vc_btn3-size-md vc_btn3-shape-rounded vc_btn3-style-classic vc_btn3-icon-right vc_btn3-color-orange" href="<?php home_url('/law-firms/'); ?>" title="">
