                        ...
                        if ( $exists ) { //Email exists 
                            ...
                            if ( ! is_wp_error( $user_id ) ) {
                                ...
                                if(!is_wp_error($post_id)){
                                    ...
                                    add_post_meta( $post_id, 'rating_count', $rating_count, true );
                                    add_post_meta( $post_id, 'total_rating', $total_rating, true );
                                    ...
                                    echo "<p style='color:red;'>Error on adding post. Sheet row id: ".$upload_id."</p>";
                                }    
                                ...
                                echo "<p style='color:red;'>Error on creating User. Sheet row id: ".$upload_id."</p>";
